...
# Original script By Yannick Heiser. Modified by Miguel Moreno.
...
def label_grains(clean_img,original_img,file_name,n,pixels_to_um):
    ...
    if not os.path.exists(join("/home/miguel/Documents/10_projects/reGrainable/data/csv/grain_properties", file_name[:-4])):
        os.makedirs(join("/home/miguel/Documents/10_projects/reGrainable/data/csv/grain_properties", file_name[:-4]))
    output_file = open("/home/miguel/Documents/10_projects/reGrainable/data/csv/grain_properties/{}/".format(file_name[:-4])+fname, 'w')
